...
await page.setViewportSize({width:1000,height:1200});await page.goto(site.url+'/edicao-impressa');await page.evaluate(()=>document.fonts.ready);await page.locator('img').evaluateAll(imgs=>Promise.all(imgs.map(img=>img.decode().catch(()=>{}))));
